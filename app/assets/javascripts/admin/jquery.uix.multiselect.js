...
;(function($, window, undefined) {
    ...
    $.widget("uix.multiselect", {
        options: {
            ...
            splitRatio: 0.505,              // % of the left list's width of the widget total width (default 0.55)
        ...
        _initSearchable: function() {
            ...
            if (this.options.searchField) {
                ...
                this._searchField = $('<input type="text" placeholder="搜索"/>').addClass('uix-search ui-widget-content ui-corner-' + (isToggle ? 'left' : 'all'))[isToggle ? 'hide' : 'show']()
                    .insertBefore( this._headers[searchHeader] )
        ...
        _resize: function() {
            ...
            if (this._searchField) {
                this._searchField.width( (sSize === 'Width' ? cAv - 20 : this.element.width()) - (isToggle ? 52 : 26) );  // issue #50
            }
